...
typedef std::map<int,FriendInfo*>   mapFriendInfo;    //好友信息表  <好友id，好友信息>

// 用户账号 +  群用户信息
typedef std::map<int,GroupUserInfo*>   mapGroupUserInfo; //<用户账号,用户群消息>
// 群号 + 群成员表
typedef std::map<int,mapGroupUserInfo>   mapGroupInfo;//<群号,群用户>
// 群号 + 群聊信息
typedef std::map<int,GroupChatInfo*>   mapGroupChatInfo;//<群号，群信息>
...
private:
    static ChatInfoManage* m_pInstance;//单例模式
